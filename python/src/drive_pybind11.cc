...
void init_drive(pybind11::module & m) {
  pybind11::class_<Drive>(m, "Drive")
    ...
    .def_static("max_turning_speed", &Drive::max_turning_speed, pybind11::arg("curvature"))
    .def_static("max_turning_curvature", &Drive::max_turning_curvature, pybind11::arg("speed"))
    .def_static("throttle_accel", &Drive::throttle_accel, pybind11::arg("speed"))
    .def("step", &Drive::step);
}
