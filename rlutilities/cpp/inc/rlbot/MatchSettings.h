...
enum GameMode { Soccer, Hoops, Dropshot, Hockey, Rumble };
...
enum class MatchLength { Five_Minutes, Ten_Minutes, Twenty_Minutes, Unlimited };

enum class MaxScore { Unlimited, One_Goal, Three_Goals, Five_Goals };
...
enum class GameSpeedOption { Default, Slo_Mo, Time_Warp };

enum class BallMaxSpeedOption { Default, Slow, Fast, Super_Fast };

enum class BallTypeOption { Default, Cube, Puck, Basketball };

enum class BallWeightOption { Default, Light, Heavy, Super_Light };

enum class BallSizeOption { Default, Small, Large, Gigantic };

enum class BallBouncinessOption { Default, Low, High, Super_High };
...
enum class BoostStrengthOption { One, OneAndAHalf, Two, Ten };

enum class GravityOption { Default, Low, High, Super_High };
