...
template <typename T>
FLATBUFFERS_CONSTEXPR_CPP14 T HashFnv1(const char *input) {
...
template <typename T>
FLATBUFFERS_CONSTEXPR_CPP14 T HashFnv1a(const char *input) {
  T hash = FnvTraits<T>::kOffsetBasis;
  for (const char *c = input; *c; ++c) {
    hash ^= static_cast<unsigned char>(*c);
    hash *= FnvTraits<T>::kFnvPrime;
...
template <>
FLATBUFFERS_CONSTEXPR_CPP14 inline uint16_t HashFnv1<uint16_t>(
    const char *input) {
...
template <>
FLATBUFFERS_CONSTEXPR_CPP14 inline uint16_t HashFnv1a<uint16_t>(
    const char *input) {
