...
namespace morton {
  ...
  inline uint32_t expand2(const uint32_t a) { return 0; }

  inline uint32_t compress2(const uint32_t a) { return 0; }
  ...
  inline uint32_t compress3(const uint32_t a) { return 0; }

  inline void encode(uint32_t& code, const uint32_t x, const uint32_t y,
    const uint32_t z) {
